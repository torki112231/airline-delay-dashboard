...
The original dataset was cleaned by removing cancelled and diverted flights, handling missing values, and merging airline and airport information. The cleaned dataset contains 5,714,008 records.

To reduce training time while preserving seasonal representation, a balanced sample of 96,000 flights (8,000 flights from each month) was used for training the machine learning models.
